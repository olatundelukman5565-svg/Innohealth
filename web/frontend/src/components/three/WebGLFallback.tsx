...
export function WebGLFallback({ message = "3D visualization requires WebGL" }: { message?: string }) {
  return (
    <div className="flex h-full min-h-[320px] w-full flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-border bg-surface/60 px-6 text-center">
